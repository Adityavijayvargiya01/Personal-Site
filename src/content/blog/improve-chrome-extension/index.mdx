---
title: 'Building Improve: A Chrome Extension for Better Writing'
description: 'How I solved my writing anxiety by building a Chrome extension that brings AI-powered text enhancement directly to your browser toolbar.'
date: 2025-06-04
tags: ['Personal Project' , 'Chrome Extension', 'AI', 'Writing']
image: './wallhaven-rq7jw1_3840x2160.png'
author: 'Aditya'
---
...
[![Coming Soon - Chrome Web Store](https://img.shields.io/badge/Coming%20Soon-Chrome%20Web%20Store-4285F4?style=for-the-badge&logo=googlechrome&logoColor=white)](https://chrome.google.com/webstore)
...
I have exciting plans for future versions:

- **Right-click Integration**: Directly improve text when you right-click on it anywhere in the browser
- **Pro Version with Multiple Models**: Access to other premium models (subscription-based due to server costs)
- **Community-Driven Features**: Custom styles, multi-language support, and other features users request most
